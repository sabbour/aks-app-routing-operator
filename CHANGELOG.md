...
### Added
- enable event-driven reconciliation for managed external-dns - [link](https://github.com/Azure/aks-app-routing-operator/pull/622)
...
### Changed
- switch from attempting to exclude dynatrace from app-routing-system ns switch to explicitly disallowing on ingress-nginx pods - [link](https://github.com/Azure/aks-app-routing-operator/pull/602)
...
### Fixed
- fix obj updated logic for SPC owner updates to prevent infinite loop - [link](https://github.com/Azure/aks-app-routing-operator/pull/564)
...
### Added
- toggle for default domain external dns gateway - [link](https://github.com/Azure/aks-app-routing-operator/pull/535)
- Gateway API for external dns + keyvault tls - [link](https://github.com/Azure/aks-app-routing-operator/pull/531)

### Changed
- take in full default domain server address - [link](https://github.com/Azure/aks-app-routing-operator/pull/536)
...
### Added
- default domain sa and external dns reconciler - [link](https://github.com/Azure/aks-app-routing-operator/pull/513)

## [0.2.12] - 2025-11-04

### Added
- bumped Go version + Go dependencies - [link](https://github.com/Azure/aks-app-routing-operator/pull/507)

## [0.2.11] - 2025-11-03

### Added
- ingress annotation logging - [link](https://github.com/Azure/aks-app-routing-operator/pull/501)
- hobo node anti affinity - [link](https://github.com/Azure/aks-app-routing-operator/pull/505)
...
### Fixed
- fixed spc cloud name key - [link](https://github.com/Azure/aks-app-routing-operator/pull/494)

## [0.2.7-1] - 2025-08-15

### Changed
- bumped external dns to 0.17.0 and a Go cve fix - [link](https://github.com/Azure/aks-app-routing-operator/pull/487)
